...
public interface IDistributedLock
{
    ...
    ValueTask<IDistributedSynchronizationHandle?> TryAcquireAsync(DateTimeOffset timeout = default, CancellationToken cancellationToken = default);
    ...
    ValueTask<IDistributedSynchronizationHandle> AcquireAsync(DateTimeOffset? timeout = null, CancellationToken cancellationToken = default);
}